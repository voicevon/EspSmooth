...
extern "C" void vApplicationStackOverflowHook( TaskHandle_t pxTask, char *pcTaskName )
{
    ...
    Board::getInstance()->LED_Set(0, true);
    Board::getInstance()->LED_Set(1, false);
    Board::getInstance()->LED_Set(2, true);
    Board::getInstance()->LED_Set(3, true);
   __asm_("bkpt #0");
    for( ;; );
}
...
extern "C" void HardFault_Handler(void) {
    Board::getInstance()->LED_Set(0, true);
    Board::getInstance()->LED_Set(1, true);
    Board::getInstance()->LED_Set(2, false);
    Board::getInstance()->LED_Set(3, false);
    __asm_("bkpt #0");
    for( ;; );
}