...
class Application {
 public:
   ...
   * If the loop() method takes longer than the target interval, espsmooth won't
   * sleep in loop(), but if the time spent in loop() is small than the target, espsmooth
