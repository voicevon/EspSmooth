...
static const char *LOG_LEVEL_COLORS[] = {
    "",                                            // NONE
    espsmooth_LOG_BOLD(espsmooth_LOG_COLOR_RED),       // ERROR
    espsmooth_LOG_COLOR(espsmooth_LOG_COLOR_YELLOW),   // WARNING
    espsmooth_LOG_COLOR(espsmooth_LOG_COLOR_GREEN),    // INFO
    espsmooth_LOG_COLOR(espsmooth_LOG_COLOR_MAGENTA),  // CONFIG
    espsmooth_LOG_COLOR(espsmooth_LOG_COLOR_CYAN),     // DEBUG
    espsmooth_LOG_COLOR(espsmooth_LOG_COLOR_GRAY),     // VERBOSE
    espsmooth_LOG_COLOR(espsmooth_LOG_COLOR_WHITE),    // VERY_VERBOSE
};
...
void Logger::pre_setup() {
  if (this->baud_rate_ > 0) {
    ...
    this->hw_serial_->setDebugOutput(espsmooth_LOG_LEVEL >= espsmooth_LOG_LEVEL_VERBOSE);
#endif
  }
#ifdef ARDUINO_ARCH_ESP8266
  else {
...
void Logger::dump_config() {
  ...
  ESP_LOGCONFIG(TAG, "  Level: %s", LOG_LEVELS[espsmooth_LOG_LEVEL]);
...
void Logger::write_footer_() { this->write_to_buffer_(espsmooth_LOG_RESET_COLOR, strlen(espsmooth_LOG_RESET_COLOR)); }
