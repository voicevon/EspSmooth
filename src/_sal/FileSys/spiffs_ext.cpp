...
// std::string spiffs_read(const std::string& file_name){
//     printf(" spiffs_read  spiffs_read  spiffs_read  spiffs_read \n");
//     delay(1000);
...
//     File file = SPIFFS.open (file_name.c_str(), FILE_READ);
//     if(!file) {
